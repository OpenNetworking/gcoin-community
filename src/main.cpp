...
public:
    ...
    bool Apply(const CTransaction &tx, const CBlock *pblock)
    {
        ...
        CScript licenseaddr = _createmultisig_redeemScript(max(1, (int)(palliance->NumOfMembers() * Params().LicenseThreshold())), key);
        ...
        CScript mineraddr = _createmultisig_redeemScript(max(1, (int)(palliance->NumOfMembers() * Params().MinerThreshold())), key);
