...
extern json_spirit::Value ValueFromAmount(const std::map<type_Color, int64_t>& origin);
...
extern json_spirit::Value getfixedaddress(const json_spirit::Array& params, bool fHelp); // in rpcwallet.cpp
